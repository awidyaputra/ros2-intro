...
var app = (function () {
    ...
    */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 36, 2, 549);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 39, 4, 599);
    			add_location(p, file, 37, 2, 577);
    			attr_dev(main, "class", "svelte-1e9puaw");
    			add_location(main, file, 35, 0, 540);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ io: lib$1, socket, message, console });
